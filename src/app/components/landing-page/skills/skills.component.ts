...
export class SkillsComponent {
  ...
  ngOnInit(): void {
    this.carousel.slider1 = this.shuffleArray(this.skills.splice(0,4));
    this.carousel.slider1 = this.carousel.slider1.concat(this.carousel.slider1);
    this.carousel.slider1 = this.carousel.slider1.concat(this.carousel.slider1);
    this.carousel.slider1 = this.carousel.slider1.concat(this.carousel.slider1);

    this.carousel.slider2 = this.shuffleArray(this.skills.splice(0,4));
    this.carousel.slider2 = this.carousel.slider2.concat(this.carousel.slider2);
    this.carousel.slider2 = this.carousel.slider2.concat(this.carousel.slider2);
    this.carousel.slider2 = this.carousel.slider2.concat(this.carousel.slider2);

    this.carousel.slider3 = this.shuffleArray(this.skills.splice(0,4));
